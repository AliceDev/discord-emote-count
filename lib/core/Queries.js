...
queries.insertChannel = " INSERT INTO channels (channel_id) VALUES (?); ";
queries.updateChannel = " INSERT INTO channels (channel_id, latest_message_id, earliest_message_id) VALUES (?, ?, ?); ";
queries.fetchChannels = " SELECT channel_id, latest_message_id, earliest_message_id FROM channels; ";

...
class Cassandra {
    ...
    async updateChannel(channel_id, latestParsed_id, earliestParsed_id) {
        await this.client.execute(queries.updateChannel, [ channel_id, latestParsed_id, earliestParsed_id ], { prepare: true });
    }

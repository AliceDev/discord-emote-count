...
class Cassandra {
    ...
    async recordEmote(emote_id, name, is_animated, server_id) {
        await this.client.execute(queries.insertEmoteMetadata, [ emote_id, name, is_animated, server_id ], { prepare: true });
    }

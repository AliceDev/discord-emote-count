...
class Cassandra {
    ...
    async recordChannel(channel_id) {
        await this.client.execute(queries.insertChannel, [ channel_id ], { prepare: true });
    }

    async updateChannel(channel_id, latest_message_id, earliest_message_id) {
        await this.client.execute(queries.updateChannel, [ channel_id, latest_message_id, earliest_message_id ], { prepare: true });
    }

...
behavior. The [config.json](./config/config.json) file allows you to specify config
values in the same way they're defined in the [defaults](./config/default.json). Values
listed in the config will take precedence over defaults.
